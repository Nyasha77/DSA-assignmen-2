...
public function main() returns error? {
    ...
    io:println("Express delivery service started.");
        ...
        foreach var kafkaRecord in records {
            ...
            sql:ExecutionResult|sql:Error shipmentResult = dbClient->execute(
                `INSERT INTO shipments (
                    ...
                    ${shipmentId}, ${customerId}, 'express', ${pickupLocation}, 
            ...
            io:println("Express shipment inserted successfully with ID: ", shipmentId);
        }
    }
}