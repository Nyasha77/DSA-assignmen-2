...
kafka:ConsumerConfiguration consumerConfig = {
    ...
    topics: ["logistics-to-international"],
...
public function main() returns error? {
    ...
    io:println("International delivery service started.");
        ...
        foreach var kafkaRecord in records {
            ...
            sql:ExecutionResult|sql:Error shipmentResult = dbClient->execute(
                `INSERT INTO shipments (
                    ...
                    ${shipmentId}, ${customerId}, 'international', ${pickupLocation}, 
            ...
            io:println("International shipment inserted successfully with ID: ", shipmentId);
        }
    }
}